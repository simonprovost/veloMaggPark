...
class App extends Component {
  ...
  _allParkPos = () => {
    ...
    fetch(
      'https://data.montpellier3m.fr/sites/default/files/ressources/TAM_MMM_VELOMAG.xml',
    )
      ...
      .then(response => {
        ...
        for (let i = 0; i < xml.getElementsByTagName('si').length; i++) {
          ...
          let creditCardReader = xml.getElementsByTagName('si')[i].attributes
            .cb;
    ...
    return (
      <View style={styles.container}>
        <Header
          ...
          centerComponent={
            <Text h4 style={styles.titleHeader}>
              {'Velo Magg Park'}
            </Text>
          }
