...
class CustomCalloutView extends React.Component {
	...
	render() {
		let creditCard = this.props.creditCardReader === '1' ? <View style={styles.bottomLeftIcon}>
			<Icon
				name='cc-visa'
				type={'font-awesome'}
				color='#6495ED'
		...
		return (
			<View style={styles.popupView}>
				...
				<View style={styles.bottomLeftSide}>
					<Text style={styles.descrPopup}>
						{this.props.occupiedPlaces}
					</Text>
...
export default class Map extends Component  {
	...
	renderMarkers() {
		return this.props.places.map((place, i) => (
			<Marker
				key={i} coordinate={place.coordinates}
				pinColor={place.color} opacity={0.8}
			>
				<Icon
					name='ios-bicycle'
					type='ionicon'
